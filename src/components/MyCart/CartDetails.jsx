        ...
        <div className="sm:p-12 my-12 font-Roboto max-w-7xl mx-auto  ">
            <div className="grid grid-cols-5 gap-6 px-12 ">
                <div className="col-span-2 space-y-4">
                    <figure><img className="w-[350px] h-[400px] border-[2px] p-2 " src={image} alt="image coming soon" /></figure>
                    <figure><img className="w-[350px] h-[400px] border-[2px] p-2 " src={image.slice(1)} alt="image coming soon" /></figure>
                    <figure><img className="w-[350px] h-[400px] border-[2px] p-2" src={image.slice(2)} alt="image coming soon" /></figure>
                ...
                <div className="col-span-3 space-y-6">
                    ...
                    <hr />
                    <p className="text-3xl font-Fira text-green-500">  {price} </p>
                        ...
                        <table className="table table-zebra">
                            ...
                            <tbody className="bg-gray-200 text-[16px] ">
                                ...
                                <tr>
                                    ...
                                    <td className="opacity-70">{category}</td>
                                </tr>
                                {/* row 3 */}
                                <tr>
                                    <td className="font-bold">Available: </td>
                                    <td className="opacity-70"> {stock} </td>
                                </tr>
                                <tr>
                                    <td className="font-bold">Processing Time: </td>
                                    <td className="opacity-70"> {time} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="lg:flex gap-2  pt-24 ">
                        <div>
                            <figure><img className="w-[350px] h-[400px] border-[2px] p-6" src={image.slice(3)} alt="image coming soon" /></figure>
                        </div>
                        <div>
                            <figure><img className="w-[350px] h-[400px] border-[2px] p-6" src={image.slice(4)} alt="image coming soon" /></figure>
                        </div>
                    </div>
                </div>
            </div>
